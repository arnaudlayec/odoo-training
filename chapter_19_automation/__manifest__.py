{
    ...
    "data": [
        ...
        # Chargée après library_category_data.xml (ref sur library_book_category_novel) et
        # library_book_mail_template.xml (référencé par xml_id dans le code de l'action serveur).
        "data/library_book_automation_data.xml",
    ],
    "demo": [
